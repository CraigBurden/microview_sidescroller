...
static const uint8_t PROGMEM man_run_bmp[][32] =
{
  {
    0b00000001, 0b10000000,
    0b00000011, 0b11000000,
    ...
    0b00000011, 0b11000000,
    0b00000001, 0b10000000,
    0b00001111, 0b10001000,
    0b00001001, 0b01010000,
...
static const uint8_t PROGMEM tortoise_bmp[][32] =
{
  {
    0b00000000, 0b00000000,
    0b00000000, 0b00000000,
  ...
  },
  {
    ...
    0b01011011, 0b111100100,
    0b01111111, 0b111111100,
    0b01111111, 0b111111000,
    0b00000011, 0b111110000,
    0b00000011, 0b001100000
  }
};
...
void loop()
{
  ...
  display.drawBitmap(OLED_PIXEL_WIDTH_OFFSET, OLED_PIXEL_HEIGHT - SPRITE_HEIGHT - 1, man_run_bmp[1], SPRITE_WIDTH, SPRITE_HEIGHT, 1);

  display.drawBitmap(OLED_PIXEL_WIDTH_OFFSET + 30, OLED_PIXEL_HEIGHT - SPRITE_HEIGHT - 1, tortoise_bmp[1], SPRITE_WIDTH, SPRITE_HEIGHT, 1);
